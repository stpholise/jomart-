...
const RequestForm = ({
  ...
  return (
    <>
      <div className="fixed text-[#262626] top-0 left-0 right-0 bottom-0 lg:top-3 lg:bottom-1/2 lg:left-1/2 lg:right-1/2 lg:-translate-x-1/2  w-full rounded-lg px-4 py-4 lg:px-6 lg:py-6 max-w-xl z-80  lg:w-140 lg:h-[96vh] bg-white shadow-xl">
        {loading && (
